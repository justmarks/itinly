...
> = {
  ...
  "place.create":     { icon: <MapPin className="h-3.5 w-3.5" />,           tone: "create" },
  "place.update":     { icon: <MapPin className="h-3.5 w-3.5" />,           tone: "update" },
  "place.delete":     { icon: <MapPin className="h-3.5 w-3.5" />,           tone: "delete" },
